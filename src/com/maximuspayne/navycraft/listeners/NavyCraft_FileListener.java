          ...
          FileConfiguration playerData = YamlConfiguration.loadConfiguration(f);
			if(playerData.getInt(player + ".SHIP1") > 0) {
				...
				if( NavyCraft.playerHANGAR1Rewards.containsKey(player) )
			  		NavyCraft.playerHANGAR1Rewards.put(player, NavyCraft.playerHANGAR1Rewards.get(player) + Integer.valueOf(playerData.get(player + ".HANGAR1").toString()));
				else
				...
				if( NavyCraft.playerHANGAR2Rewards.containsKey(player) )
			  		NavyCraft.playerHANGAR2Rewards.put(player, NavyCraft.playerHANGAR2Rewards.get(player) + Integer.valueOf(playerData.get(player + ".HANGAR2").toString()));
				else
				...
				if( NavyCraft.playerTANK1Rewards.containsKey(player) )
			  		NavyCraft.playerTANK1Rewards.put(player, NavyCraft.playerTANK1Rewards.get(player) + Integer.valueOf(playerData.get(player + ".TANK1").toString()));
				else
				...
				if( NavyCraft.playerTANK2Rewards.containsKey(player) )
			  		NavyCraft.playerTANK2Rewards.put(player, NavyCraft.playerTANK2Rewards.get(player) + Integer.valueOf(playerData.get(player + ".TANK2").toString()));
				else
				...
				if( NavyCraft.playerMAP1Rewards.containsKey(player) )
			  		NavyCraft.playerMAP1Rewards.put(player, NavyCraft.playerMAP1Rewards.get(player) + Integer.valueOf(playerData.get(player + ".MAP1").toString()));
				else
				...
				if( NavyCraft.playerMAP2Rewards.containsKey(player) )
			  		NavyCraft.playerMAP2Rewards.put(player, NavyCraft.playerMAP2Rewards.get(player) + Integer.valueOf(playerData.get(player + ".MAP2").toString()));
				else
				...
				if( NavyCraft.playerMAP3Rewards.containsKey(player) )
			  		NavyCraft.playerMAP3Rewards.put(player, NavyCraft.playerMAP3Rewards.get(player) + Integer.valueOf(playerData.get(player + ".MAP3").toString()));
				else
				...
				if( NavyCraft.playerMAP4Rewards.containsKey(player) )
			  		NavyCraft.playerMAP4Rewards.put(player, NavyCraft.playerMAP4Rewards.get(player) + Integer.valueOf(playerData.get(player + ".MAP4").toString()));
				else
				...
				if( NavyCraft.playerMAP5Rewards.containsKey(player) )
			  		NavyCraft.playerMAP5Rewards.put(player, NavyCraft.playerMAP5Rewards.get(player) + Integer.valueOf(playerData.get(player + ".MAP5").toString()));
				else
