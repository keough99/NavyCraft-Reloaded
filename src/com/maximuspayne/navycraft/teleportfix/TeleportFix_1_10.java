...
public class TeleportFix_1_10 implements Listener {
	...
	public static void updateNMSLight(Location light, Location oldLight) {
		if( oldLight != null ) {
			...
			ArrayList<net.minecraft.server.v1_10_R1.Chunk> chunks = new ArrayList<net.minecraft.server.v1_10_R1.Chunk>();
			
			for (Player p : oc.getWorld().getPlayers() ) {
				net.minecraft.server.v1_10_R1.Chunk nmsChunk = ((CraftChunk)oc).getHandle();
				...
				for( net.minecraft.server.v1_10_R1.Chunk ck : chunks )
				{
					PlayerConnection connection = ((CraftPlayer) p).getHandle().playerConnection;
		...
		if( light != null ) {
			...
			for (Player p : c.getWorld().getPlayers() ) {
				net.minecraft.server.v1_10_R1.Chunk nmsChunk = ((CraftChunk)c).getHandle();
