...
public class ConfigFile {
	...
	public ConfigFile() {
		...
		ConfigSettings.put("UniversalHelmId", "294");
		...
		ConfigSettings.put("RequireHelm", "false");
		...
		ConfigComments.put("UniversalHelmId", "<Number:294> The item ID of the item that works on all vehicles.");
		...
		ConfigComments.put("RequireHelm", "<true/FALSE> The vehicle only moves if you have the helm.");
